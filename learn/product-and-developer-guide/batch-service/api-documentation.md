...
{% swagger src="../../../.gitbook/assets/coursebatchmanapi (1) (4).yaml" path="/course/v1/batch/read/{batch-id}" method="get" %}
...
{% swagger src="../../../.gitbook/assets/coursebatchmanapi (1) (4).yaml" path="/course/v1/batch/list" method="post" %}
[coursebatchmanapi (1) (4).yaml](<../../../.gitbook/assets/coursebatchmanapi (1) (4).yaml>)
{% endswagger %}
