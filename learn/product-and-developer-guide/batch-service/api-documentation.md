...
{% swagger src="../../../.gitbook/assets/courseenrolmentapi (1) (4).yaml" path="/course/v1/user/enrollment/list/{user-id}" method="get" %}
[courseenrolmentapi (1) (4).yaml](<../../../.gitbook/assets/courseenrolmentapi (1) (4).yaml>)
{% endswagger %}
