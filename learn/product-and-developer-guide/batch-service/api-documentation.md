...
{% swagger src="../../../.gitbook/assets/coursebatchmanapi (1) (1).yaml" path="/course/v1/batch/update" method="patch" %}
...
{% swagger src="../../../.gitbook/assets/courseenrolmentapi (1) (3).yaml" path="/course/v1/user/enrollment/list/{user-id}" method="get" %}
[courseenrolmentapi (1) (3).yaml](<../../../.gitbook/assets/courseenrolmentapi (1) (3).yaml>)
{% endswagger %}
