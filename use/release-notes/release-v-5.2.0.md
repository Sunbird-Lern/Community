...
| Component           | Build Jenkins Job           | Build Tags                                                                                                                                                                    | Deploy Jenkins Job           | Deploy Tags (Devops) | Comment |
| ------------------- | --------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------- | -------------------- | ------- |
| Batch Service       | Build/Core/Lms              | <p>sunbird-course-service : <a href="https://github.com/Sunbird-Lern/sunbird-course-service/releases/tag/release-5.2.0_RC2">release-5.2.0_RC2</a></p><p><br></p>              | Deploy/Kubernetes/Lms        | release-5.2.0        |         |
| Data pipeline       | Build/Lern/FlinkJobs        | <p>data-pipeline : <br><a href="https://github.com/Sunbird-Lern/data-pipeline/releases/tag/release-5.2.0_RC1">release-5.2.0_RC1</a></p>                                       | Deploy/Lern/FlinkJobs        | release-5.2.0        |         |
| User\&Org Service   | Build/Core/Learner          | sunbird-lms-service : [release-5.2.0\_RC1](http://localhost:5000/s/aQ7wCJOT0ZaejHUiD6sb/about/product-and-developer-guide/adapters/file-adapter/excel-ftp-and-sftp-handler)   | Deploy/Kubernetes/Learner    | release-5.2.0        |         |
| Data Products       | Build/Lern/LernDataProducts | <p>data-products : <br><a href="https://github.com/Sunbird-Lern/data-products/releases/tag/release-5.2.0_RC1">release-5.2.0_RC1</a></p>                                       | Deploy/Lern/LernDataProducts | release-5.2.0        |         |
| Cassandra Migration | Build/Core/Cassandra        | sunbird-utils : [release-5.2.0\_RC1](https://github.com/Sunbird-Lern/sunbird-utils/releases/tag/release-5.2.0\_RC1)                                                           | Deploy/Kubernetes/Cassandra  | release-5.2.0        |         |
